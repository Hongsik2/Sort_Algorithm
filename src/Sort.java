...
interface Dummy {
    ...
    public default void PartiallySorted(int[] a, int num) {     //배열을 일부분만 정렬하고 나머지는 랜덤으로 채움
        ...
        int r = random.nextInt(num - (num / 10) - 1);
...
public class Sort {
    ...
    static class ShellSort implements Sorting {
        public void sort(int[] a, int num) {
                ...
                for (int z = 1; z < 30; z++) {   //입력의 개수별로 반복실행 (z*100개)
                    ...
                    switch (y) {
                        ...
                        case 3:
                            ...
                            data[x][y][z] = (int) timediff3;
                            break;
                    }
                }
            }
        }
        writeExcel.writeExcel(data);
